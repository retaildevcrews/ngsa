    ...
    public static class AsciiArt
    {
        ...
        private static void Santa()
        {
            ...
            if (File.Exists(file))
            {
                ...
                // show the art
                foreach (var l2 in lrandom.Values)
                {
                    Console.SetCursorPosition(l2.Col, l2.Row);
                    Console.ForegroundColor = l2.Color;
                    Console.Write(l2.Value);
